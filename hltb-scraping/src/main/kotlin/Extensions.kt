...
internal fun Request.hltbDefaultHeaders(url: String, bodyIsJson: Boolean = true): Request {
...
internal inline fun <reified T : Any> Request.hltbJsonRequest(url: String, body: T): Request {
